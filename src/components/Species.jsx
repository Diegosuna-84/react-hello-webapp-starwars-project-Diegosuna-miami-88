...
export const SpeciesCard = ({name, classification, average_lifespan, language, id}) => {
    ...
    return (
        <div className="cardStyle col-12 col-lg-4 mx-3 border rounded border-secondary text-center card">
            <img src={`https://github.com/breatheco-de/swapi-images/blob/master/public/images/species/${id}.jpg?raw=true`} className="img-thumbnail img-fluid rounde placeholder" alt="..."></img>
             <div className="card-body">
                ...
                <button className="btn btn-primary" onClick={() => dispatch({ type: "toggle_favorite", payload: { name: name, uid: id, kind: "species" } })}>Faves</button>
        </div>
    )
}